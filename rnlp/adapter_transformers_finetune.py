...
def go(model_name, task_name, adapter_config, labels=None, config_name = None, tokenizer_name=None, revision=None, adapter_non_linearity = None, adapter_reduction_factor = None, load_adapter=None, extra_adapters={}):
